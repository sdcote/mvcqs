...
<%@ taglib prefix="mvcqs" uri="/WEB-INF/mvcqs.tld"%><!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<!--  THis profile came from http://bootsnipp.com/snippets/featured/flat-user-profile-ui  -->
						<div class="container">
							<div class="row">
											...
											<div class="col-xs-12 col-sm-8">
												...
												<p>
													<strong>Skills: </strong> <span class="tags">html5</span> <span
														class="tags">css3</span> <span class="tags">jquery</span>
											...
											<div class="col-xs-12 col-sm-4 text-center">
												<figure>
													...
													<figcaption class="ratings">
														<p>
															Ratings <a href="#"> <span class="fa fa-star"></span></a> <a href="#"> <span class="fa fa-star"></span></a> <a href="#"> <span class="fa fa-star"></span></a> <a href="#"> <span class="fa fa-star"></span></a> <a href="#"> <span class="fa fa-star-o"></span></a>
														</p>
													</figcaption>
												</figure>
											</div>
											...
											<div class="col-xs-12 col-sm-4 emphasis">
												...
												<div class="btn-group dropup btn-block">
													...
													<ul class="dropdown-menu text-left" role="menu">
														<li><a href="#"><span
																class="fa fa-envelope pull-right"></span> Send an email
														</a></li>
														<li><a href="#"><span
																class="fa fa-list pull-right"></span> Add or remove from
																a list </a></li>
														<li class="divider"></li>
														<li><a href="#"><span
																class="fa fa-warning pull-right"></span>Report this user
																for spam</a></li>
														<li class="divider"></li>
