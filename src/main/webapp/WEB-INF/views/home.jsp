			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						...
						<p>If the session is logged-in, then the navigation menu will
							show what options are available to the currently logged-in user.
							Anonymous session (those not logged-in) will see the basic home
							page.</p>
					</div>
					<!-- /.col-lg-12 -->
				</div>
